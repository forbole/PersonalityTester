...
exports.download_compute = exports.uploads_to_parcel = void 0;
...
function uploads_to_parcel(address, actual_data) {
...
function download_compute(address) {
    return __awaiter(this, void 0, void 0, function () {
        var endUserIdentityAddress, adminConfig, adminIdentityAddress, _a, _b, adminIdentity, writestream, streamFinished, datasetByEnduser, secretDataStream, secretDatasetWriter, e_1, secretDataByadmin, jobRequest, dispatcher, jobId, job, output;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Parcel.Identity.connect(adminIdentityAddress, adminConfig)];
                case 2:
                ...
                case 3:
                    datasetByEnduser = _c.sent();
                    _c.label = 4;
                case 4:
                    _c.trys.push([4, 6, , 7]);
                    secretDataStream = datasetByEnduser.download();
                ...
                case 7:
                    ...
                    return [4 /*yield*/, Parcel.Dispatcher.connect(config.dispatcherAddress, adminIdentity, config)];
                case 8:
                    dispatcher = _c.sent();
                ...
                case 10:
                    ...
                    if (!job.outputs[0]) return [3 /*break*/, 12];
                    return [4 /*yield*/, Parcel.Dataset.connect(job.outputs[0].address, adminIdentity, config)];
                case 11:
                    output = _c.sent();
